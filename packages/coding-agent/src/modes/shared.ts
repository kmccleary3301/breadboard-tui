...
const STRING_CONTROL_PATTERN =
	/(?:(?:\x1b\]|\x9d)[\s\S]*?(?:\x07|\x1b\\|\x9c)|(?:\x1b[P^_X]|[\x90\x98\x9e\x9f])[\s\S]*?(?:\x1b\\|\x9c))/g;
...
export function sanitizeStatusText(text: string): string {
	return stripVTControlCharacters(text.replace(STRING_CONTROL_PATTERN, ""))
		.replace(/[\u0000-\u001f\u007f-\u009f]/g, " ")
		.replace(/ +/g, " ")
		.trim();
}
